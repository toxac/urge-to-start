...
export type SectorType = 'general' | 'food' | 'import_export' | 'manufacturing';
export type RevenueBucket = 'pre-revenue' | 'under-20l' | '20-40l' | '40l-1cr' | '1cr-plus';
export type EmployeeBucket = '0' | '1-9' | '10-19' | '20-plus';
...
export const GROUP_META: Record<GroupType, { label: string; icon: any; color: string }> = {
...
export const REQUIREMENTS: ComplianceRequirement[] = [
  ...
  },
  {
    ...
    why: 'Applies the moment you collect names, phone numbers, or emails online. Full enforcement phases in through 2026–2027.',
