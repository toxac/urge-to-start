      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Define Build Scope", type: "blog", path_or_url: "content/blog/define-build-scope.md", subtitle: "6 min read" },
              { title: "Saying No: The Secret to Scope Management", type: "blog", path_or_url: "content/blog/saying-no-scope.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Write a Requirements Document", type: "blog", path_or_url: "content/blog/requirements-document.md", subtitle: "5 min read" },
              { title: "The 1-Page Spec: Keep It Simple", type: "blog", path_or_url: "content/blog/one-page-spec.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Set Achievable Milestones", type: "blog", path_or_url: "content/blog/achievable-milestones.md", subtitle: "5 min read" },
              { title: "The 1-Week Sprint: Start Small", type: "blog", path_or_url: "content/blog/one-week-sprint.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Builders Inventory Checklist", type: "blog", path_or_url: "content/blog/builders-inventory.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Identify Skill Gaps", type: "blog", path_or_url: "content/blog/identify-skill-gaps.md", subtitle: "5 min read" },
              { title: "Learn or Hire? How to Decide", type: "blog", path_or_url: "content/blog/learn-or-hire.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Identify Bottlenecks", type: "blog", path_or_url: "content/blog/identify-bottlenecks.md", subtitle: "4 min read" },
              { title: "The 80/20 Bottleneck Rule", type: "blog", path_or_url: "content/blog/80-20-bottleneck.md", subtitle: "3 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Build Readiness Checklist", type: "blog", path_or_url: "content/blog/build-readiness.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Build a Simple Landing Page", type: "blog", path_or_url: "content/blog/simple-landing-page.md", subtitle: "6 min read" },
              { title: "10 Landing Page Examples That Convert", type: "blog", path_or_url: "content/blog/landing-page-examples.md", subtitle: "5 min read" },
              { title: "The One Question Your Landing Page Must Answer", type: "blog", path_or_url: "content/blog/landing-page-one-question.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "Sales First Principles for Landing Pages", type: "blog", path_or_url: "content/blog/landing-page-sales-principles.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Choose Your Primary Channel", type: "blog", path_or_url: "content/blog/choose-primary-channel.md", subtitle: "5 min read" },
              { title: "The Best Bio Template for Founders", type: "blog", path_or_url: "content/blog/founder-bio-template.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The 3 Things to Say in Your First Post", type: "blog", path_or_url: "content/blog/first-post.md", subtitle: "4 min read" },
              { title: "How to Introduce Your Project to the World", type: "blog", path_or_url: "content/blog/introduce-project.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Build a Waitlist", type: "blog", path_or_url: "content/blog/build-waitlist.md", subtitle: "5 min read" },
              { title: "Waitlist Tools That Work", type: "blog", path_or_url: "content/blog/waitlist-tools.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Tell Your Network About Your Project", type: "blog", path_or_url: "content/blog/tell-network.md", subtitle: "5 min read" },
              { title: "The 3-Part Message Template", type: "blog", path_or_url: "content/blog/message-template.md", subtitle: "4 min read" },
              { title: "Personal Network Outreach Template", type: "download", path_or_url: "/resources/network-outreach-template.pdf" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Get Your First Followers", type: "blog", path_or_url: "content/blog/first-followers.md", subtitle: "5 min read" },
              { title: "The 10 People Who Matter Most", type: "blog", path_or_url: "content/blog/10-people.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Write a Community Update", type: "blog", path_or_url: "content/blog/community-update.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
    ...
    quest5: {
      ...
      ai_config: {
        ...
        on_success: {
          ...
          unlock_next_quest: "mission6_quest1"
        }
      },
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Create a Build Timeline", type: "blog", path_or_url: "content/blog/build-timeline.md", subtitle: "5 min read" },
              { title: "The 50% Buffer Rule", type: "blog", path_or_url: "content/blog/50-percent-buffer.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Plan a Weekly Sprint", type: "blog", path_or_url: "content/blog/weekly-sprint.md", subtitle: "5 min read" },
              { title: "The 4-Hour Work Week Approach to Building", type: "blog", path_or_url: "content/blog/4-hour-build.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Accountability System That Works", type: "blog", path_or_url: "content/blog/accountability-system.md", subtitle: "4 min read" },
              { title: "How to Be Accountable to Yourself", type: "blog", path_or_url: "content/blog/self-accountability.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Write a Build Manifesto", type: "blog", path_or_url: "content/blog/build-manifesto.md", subtitle: "4 min read" },
              { title: "Examples of Founder Manifestos", type: "blog", path_or_url: "content/blog/founder-manifestos.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
