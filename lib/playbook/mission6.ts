      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Stay Focused During the Build", type: "blog", path_or_url: "content/blog/stay-focused-build.md", subtitle: "5 min read" },
              { title: "The 80/20 Rule for Building", type: "blog", path_or_url: "content/blog/80-20-building.md", subtitle: "4 min read" },
              { title: "How to Announce You're Ready for Testers", type: "blog", path_or_url: "content/blog/announce-testers.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Recover from a Missed Milestone", type: "blog", path_or_url: "content/blog/recover-milestone.md", subtitle: "4 min read" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Unblock Yourself", type: "blog", path_or_url: "content/blog/unblock-yourself.md", subtitle: "5 min read" },
              { title: "When to Ask for Help", type: "blog", path_or_url: "content/blog/ask-for-help.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Run an Alpha Test", type: "blog", path_or_url: "content/blog/run-alpha-test.md", subtitle: "6 min read" },
              { title: "Alpha Test Feedback Template", type: "download", path_or_url: "/resources/alpha-feedback-template.pdf" },
              { title: "Observing Users Without Interrupting", type: "blog", path_or_url: "content/blog/observe-users.md", subtitle: "5 min read" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Synthesize User Feedback", type: "blog", path_or_url: "content/blog/synthesize-feedback.md", subtitle: "5 min read" },
              { title: "The 3 Most Important Questions to Ask", type: "blog", path_or_url: "content/blog/3-questions-feedback.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Know When to Pivot", type: "blog", path_or_url: "content/blog/when-to-pivot.md", subtitle: "6 min read" },
              { title: "The Pivot Decision Framework", type: "blog", path_or_url: "content/blog/pivot-framework.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Set Up Pre-Sales", type: "blog", path_or_url: "content/blog/setup-pre-sales.md", subtitle: "6 min read" },
              { title: "Pre-Sale Pricing Strategies", type: "blog", path_or_url: "content/blog/pre-sale-pricing.md", subtitle: "5 min read" },
              { title: "Payment Platform Setup Guide", type: "blog", path_or_url: "content/blog/payment-platforms.md", subtitle: "7 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Launch Internally", type: "blog", path_or_url: "content/blog/launch-internally.md", subtitle: "5 min read" },
              { title: "Internal Launch Outreach Templates", type: "download", path_or_url: "/resources/internal-launch-templates.pdf" },
              { title: "Community Post Template for Pre-Sales", type: "blog", path_or_url: "content/blog/community-pre-sale-post.md", subtitle: "4 min read" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Track Pre-Sales", type: "blog", path_or_url: "content/blog/track-pre-sales.md", subtitle: "4 min read" },
              { title: "What to Do If You Didn't Get Pre-Sales", type: "blog", path_or_url: "content/blog/no-pre-sales.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
    ...
    quest4: {
      ...
      ai_config: {
        ...
        on_success: {
          ...
          unlock_next_quest: "mission7_quest1"
        }
      },
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "Pre-Launch Legal Checklist", type: "blog", path_or_url: "content/blog/pre-launch-legal.md", subtitle: "6 min read" },
              { title: "What Can Wait Until After Launch", type: "blog", path_or_url: "content/blog/what-can-wait.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Launch Readiness Checklist", type: "blog", path_or_url: "content/blog/launch-readiness.md", subtitle: "5 min read" },
              { title: "What to Do the Week Before Launch", type: "blog", path_or_url: "content/blog/week-before-launch.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Know You're Ready to Launch", type: "blog", path_or_url: "content/blog/ready-to-launch.md", subtitle: "5 min read" },
              { title: "Launch Anxiety: How to Push Through", type: "blog", path_or_url: "content/blog/launch-anxiety.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
