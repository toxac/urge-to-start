      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The 5 Most Common Pricing Models", type: "blog", path_or_url: "content/blog/pricing-models-guide.md", subtitle: "6 min read" },
              { title: "Subscription vs. One-Time: Which Is Right for You?", type: "blog", path_or_url: "content/blog/subscription-vs-one-time.md", subtitle: "5 min read" },
              { title: "Pricing Model Decision Matrix", type: "download", path_or_url: "/resources/pricing-matrix.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Ask About Pricing Without Being Awkward", type: "blog", path_or_url: "content/blog/ask-about-pricing.md", subtitle: "5 min read" },
              { title: "The One Question That Tells You If You Have a Business", type: "blog", path_or_url: "content/blog/the-one-question.md", subtitle: "4 min read" },
              { title: "Pricing Interview Template", type: "download", path_or_url: "/resources/pricing-interview-template.pdf" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Pick Your First Price", type: "blog", path_or_url: "content/blog/pick-your-first-price.md", subtitle: "5 min read" },
              { title: "The Psychology of Pricing", type: "blog", path_or_url: "content/blog/psychology-of-pricing.md", subtitle: "6 min read" },
              { title: "Price as a Signal of Quality", type: "blog", path_or_url: "content/blog/price-as-signal.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The 10 Most Common Acquisition Channels", type: "blog", path_or_url: "content/blog/acquisition-channels.md", subtitle: "7 min read" },
              { title: "How to Choose Your First Channel", type: "blog", path_or_url: "content/blog/choose-first-channel.md", subtitle: "5 min read" },
              { title: "Channel Fit: What Works for Your Customer", type: "blog", path_or_url: "content/blog/channel-fit.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Run a Marketing Experiment", type: "blog", path_or_url: "content/blog/marketing-experiment.md", subtitle: "5 min read" },
              { title: "The $50 Marketing Test", type: "blog", path_or_url: "content/blog/50-dollar-test.md", subtitle: "4 min read" },
              { title: "Experiment Tracker Template", type: "download", path_or_url: "/resources/experiment-tracker.xlsx" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Calculate Customer Acquisition Cost", type: "blog", path_or_url: "content/blog/calculate-cac.md", subtitle: "5 min read" },
              { title: "The Relationship Between CAC and LTV", type: "blog", path_or_url: "content/blog/cac-ltv.md", subtitle: "6 min read" },
              { title: "When Is a Channel Worth Pursuing?", type: "blog", path_or_url: "content/blog/when-is-channel-worth-it.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Find Business Partners", type: "blog", path_or_url: "content/blog/find-business-partners.md", subtitle: "5 min read" },
              { title: "The Art of the Partnership Ask", type: "blog", path_or_url: "content/blog/art-of-partnership-ask.md", subtitle: "4 min read" },
              { title: "Partnership Models That Work", type: "blog", path_or_url: "content/blog/partnership-models.md", subtitle: "6 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Approach a Potential Partner", type: "blog", path_or_url: "content/blog/approach-partner.md", subtitle: "5 min read" },
              { title: "What to Ask in a Partnership Conversation", type: "blog", path_or_url: "content/blog/partnership-conversation.md", subtitle: "4 min read" },
              { title: "Partnership Outreach Template", type: "download", path_or_url: "/resources/partnership-template.pdf" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Structure a Partnership", type: "blog", path_or_url: "content/blog/structure-partnership.md", subtitle: "5 min read" },
              { title: "The 3 Types of Partnerships", type: "blog", path_or_url: "content/blog/3-types-partnerships.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Calculate Business Costs", type: "blog", path_or_url: "content/blog/calculate-business-costs.md", subtitle: "6 min read" },
              { title: "Fixed vs. Variable Costs: What's the Difference?", type: "blog", path_or_url: "content/blog/fixed-vs-variable.md", subtitle: "4 min read" },
              { title: "Cost Mapping Template", type: "download", path_or_url: "/resources/cost-mapping-template.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "Unit Economics for Beginners", type: "blog", path_or_url: "content/blog/unit-economics-beginners.md", subtitle: "6 min read" },
              { title: "How to Improve Your Unit Economics", type: "blog", path_or_url: "content/blog/improve-unit-economics.md", subtitle: "5 min read" },
              { title: "Unit Economics Calculator", type: "download", path_or_url: "/resources/unit-economics-calculator.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Minimum Viable Cost", type: "blog", path_or_url: "content/blog/minimum-viable-cost.md", subtitle: "4 min read" },
              { title: "How to Reduce Business Costs Without Hurting Quality", type: "blog", path_or_url: "content/blog/reduce-costs.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
    ...
    quest5: {
      ...
      ai_config: {
        ...
        on_success: {
          ...
          unlock_next_quest: "mission5_quest1"
        }
      },
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Calculate Break-Even Point", type: "blog", path_or_url: "content/blog/breakeven-calculator.md", subtitle: "6 min read" },
              { title: "What If You Never Break Even?", type: "blog", path_or_url: "content/blog/never-breakeven.md", subtitle: "4 min read" },
              { title: "Break-Even Calculator Template", type: "download", path_or_url: "/resources/breakeven-calculator.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Scenario Plan Your Business", type: "blog", path_or_url: "content/blog/scenario-planning.md", subtitle: "5 min read" },
              { title: "The Worst Case Test", type: "blog", path_or_url: "content/blog/worst-case-test.md", subtitle: "4 min read" },
              { title: "Scenario Planning Template", type: "download", path_or_url: "/resources/scenario-planning.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Know If You Have a Business", type: "blog", path_or_url: "content/blog/know-if-you-have-business.md", subtitle: "5 min read" },
              { title: "The $100 Test: Is Your Idea Viable?", type: "blog", path_or_url: "content/blog/100-dollar-test.md", subtitle: "4 min read" },
              { title: "When to Quit and When to Persevere", type: "blog", path_or_url: "content/blog/when-to-quit.md", subtitle: "6 min read" }
            ]
          }
        }
      ]
