      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Create a Customer Avatar", type: "blog", path_or_url: "content/blog/customer-avatar-guide.md", subtitle: "5 min read" },
              { title: "Why 'Everyone' Is Not Your Customer", type: "blog", path_or_url: "content/blog/everyone-is-not-your-customer.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Find People to Interview", type: "blog", path_or_url: "content/blog/find-interview-subjects.md", subtitle: "4 min read" },
              { title: "Cold Outreach That Works", type: "blog", path_or_url: "content/blog/cold-outreach.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Mom Test: How to Ask Questions That Don't Suck", type: "blog", path_or_url: "content/blog/the-mom-test.md", subtitle: "6 min read" },
              { title: "Customer Interview Template", type: "download", path_or_url: "/resources/interview-template.pdf" },
              { title: "How to Listen Without Selling", type: "youtube", path_or_url: "https://www.youtube.com/watch?v=QpYVIGWqRiM", subtitle: "10 min watch" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Synthesize Customer Interviews", type: "blog", path_or_url: "content/blog/synthesize-interviews.md", subtitle: "4 min read" },
              { title: "Finding Patterns in Customer Feedback", type: "blog", path_or_url: "content/blog/patterns-in-feedback.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Do Competitor Research", type: "blog", path_or_url: "content/blog/competitor-research.md", subtitle: "6 min read" },
              { title: "What to Look for in Competitor Reviews", type: "blog", path_or_url: "content/blog/competitor-reviews.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "Finding Your Unfair Advantage", type: "blog", path_or_url: "content/blog/unfair-advantage.md", subtitle: "5 min read" },
              { title: "When 'Better' Isn't Enough", type: "blog", path_or_url: "content/blog/better-isnt-enough.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Write a Positioning Statement", type: "blog", path_or_url: "content/blog/positioning-statement.md", subtitle: "5 min read" },
              { title: "Examples of Great Positioning", type: "blog", path_or_url: "content/blog/great-positioning-examples.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Define a Problem Statement", type: "blog", path_or_url: "content/blog/problem-statement.md", subtitle: "4 min read" },
              { title: "The 5 Whys of Problem Definition", type: "blog", path_or_url: "content/blog/5-whys.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The 4 Types of Business Solutions", type: "blog", path_or_url: "content/blog/4-business-solutions.md", subtitle: "6 min read" },
              { title: "How to Pick the Right Solution Format", type: "blog", path_or_url: "content/blog/pick-solution-format.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Choose Your Business Model", type: "blog", path_or_url: "content/blog/choose-business-model.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "Minimum Sellable Product vs. Minimum Viable Product", type: "blog", path_or_url: "content/blog/msp-vs-mvp.md", subtitle: "6 min read" },
              { title: "How to Find Your First Paying Customer", type: "blog", path_or_url: "content/blog/first-paying-customer.md", subtitle: "5 min read" },
              { title: "The 20% That Gets 80% of the Value", type: "blog", path_or_url: "content/blog/20-80-rule.md", subtitle: "4 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Use the MSP Canvas", type: "blog", path_or_url: "content/blog/msp-canvas.md", subtitle: "5 min read" },
              { title: "From Canvas to First Build", type: "blog", path_or_url: "content/blog/canvas-to-build.md", subtitle: "4 min read" }
            ]
          }
        }
      ]
    ...
    quest5: {
      ...
      ai_config: {
        ...
        on_success: {
          ...
          unlock_next_quest: "mission4_quest1"
        }
      },
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "Basic Unit Economics for Beginners", type: "blog", path_or_url: "content/blog/unit-economics.md", subtitle: "6 min read" },
              { title: "How to Price Your First Product", type: "blog", path_or_url: "content/blog/how-to-price.md", subtitle: "5 min read" },
              { title: "Customer Acquisition Cost Calculator", type: "download", path_or_url: "/resources/cac-calculator.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Estimate Build Time", type: "blog", path_or_url: "content/blog/estimate-build-time.md", subtitle: "4 min read" },
              { title: "The 50% Rule: Why Everything Takes Longer", type: "blog", path_or_url: "content/blog/50-percent-rule.md", subtitle: "3 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Make a Go/No-Go Decision", type: "blog", path_or_url: "content/blog/go-no-go.md", subtitle: "5 min read" },
              { title: "The Best Founders Pivot", type: "blog", path_or_url: "content/blog/best-founders-pivot.md", subtitle: "4 min read" },
