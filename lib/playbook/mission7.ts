...
export const mission7: Mission = {
  ...
  quests: {
    quest1: {
      ...
      estimated_off_app_minutes: 10080, // 6-8 weeks
      ...
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Execute a Public Launch", type: "blog", path_or_url: "content/blog/public-launch.md", subtitle: "6 min read" },
              { title: "Launch Announcement Template", type: "download", path_or_url: "/resources/launch-announcement-template.pdf" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The 5 Marketing Channels Every Founder Needs", type: "blog", path_or_url: "content/blog/5-marketing-channels.md", subtitle: "7 min read" },
              { title: "Email Newsletter Setup Guide", type: "blog", path_or_url: "content/blog/newsletter-setup.md", subtitle: "5 min read" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Start a Content Engine", type: "blog", path_or_url: "content/blog/content-engine.md", subtitle: "6 min read" },
              { title: "Content Idea Generator", type: "download", path_or_url: "/resources/content-ideas.pdf" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Build a Sales Pipeline", type: "blog", path_or_url: "content/blog/sales-pipeline.md", subtitle: "6 min read" },
              { title: "Sales Pipeline Template", type: "download", path_or_url: "/resources/sales-pipeline-template.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The 5 Metrics Every Founder Should Track", type: "blog", path_or_url: "content/blog/5-metrics.md", subtitle: "5 min read" }
            ]
          }
        }
      ]
    ...
    quest2: {
      ...
      ai_config: {
        ...
        on_success: {
          ...
          unlock_next_quest: "mission8_quest1"
        }
      },
      tasks: [
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Do Outbound Sales", type: "blog", path_or_url: "content/blog/outbound-sales.md", subtitle: "6 min read" },
              { title: "Outbound Outreach Templates", type: "download", path_or_url: "/resources/outbound-templates.pdf" }
            ],
        ...
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Build a Referral System", type: "blog", path_or_url: "content/blog/referral-system.md", subtitle: "5 min read" },
              { title: "Referral Request Templates", type: "download", path_or_url: "/resources/referral-templates.pdf" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Set Up Customer Support as a Founder", type: "blog", path_or_url: "content/blog/founder-support.md", subtitle: "5 min read" },
              { title: "Support Response Templates", type: "download", path_or_url: "/resources/support-templates.pdf" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "The Customer Feedback Loop", type: "blog", path_or_url: "content/blog/feedback-loop.md", subtitle: "5 min read" },
              { title: "Feedback Questions Template", type: "download", path_or_url: "/resources/feedback-questions.pdf" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Track Revenue as a Founder", type: "blog", path_or_url: "content/blog/track-revenue.md", subtitle: "4 min read" },
              { title: "Revenue Tracking Template", type: "download", path_or_url: "/resources/revenue-tracker.xlsx" }
            ]
          }
        },
        {
          ...
          ai_config: {
            recommendations: [
              { title: "How to Run a Quarterly Business Review", type: "blog", path_or_url: "content/blog/quarterly-review.md", subtitle: "6 min read" },
              { title: "Quarterly Review Template", type: "download", path_or_url: "/resources/quarterly-review-template.pdf" }
            ],
