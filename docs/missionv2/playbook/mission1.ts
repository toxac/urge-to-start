...
const mission1: MissionSchema = {
    ...
    quests: [
        ...
        // ============================================
        {
            ...
            content_path: "content/missions/mission1/quests/your-resources.md",
            video_url: "https://evkkxeuiszjpzjpcmkwe.supabase.co/storage/v1/object/public/mission_videos/test.webm",
            sequence: 2,
            estimated_in_app_minutes: 30,
            estimated_off_app_minutes: 60,
        ...
        // ============================================
        {
            id: "mission1_quest3",
            title: "Start Asking",
            content_path: "content/missions/mission1/quests/ask-and-you-shall-receive.md",
            video_url: "https://evkkxeuiszjpzjpcmkwe.supabase.co/storage/v1/object/public/mission_videos/test.webm",
            sequence: 3,
            estimated_in_app_minutes: 30,
        ...
        // ============================================
        {
            ...
            content_path: "content/missions/mission1/quests/hearing-nos.md",
            video_url: "https://evkkxeuiszjpzjpcmkwe.supabase.co/storage/v1/object/public/mission_videos/test.webm",
            sequence: 4,
