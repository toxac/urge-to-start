...
export function SidebarComponent() {
  ...
  return (
    <aside className="w-64 h-full bg-card border-r border-border p-5 flex flex-col justify-between select-none shrink-0 text-foreground">
        ...
        <nav className="space-y-1 font-sans text-xs font-semibold tracking-normal">
          <Link 
            ...
            className={`flex items-center justify-between px-3 py-2.5 rounded-xl transition group border ${
              isActive('/platform/dashboard') ? 'bg-primary/5 text-primary border-primary/20 shadow-sm' : 'border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50'
            }`}
          >
          ...
          {profile?.roles?.includes('member') && (
            <Link 
              ...
              className={`flex items-center justify-between px-3 py-2.5 rounded-xl transition group border ${
                isActive('/platform/program') ? 'bg-primary/5 text-primary border-primary/20 shadow-sm' : 'border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50'
              }`}
            >
          ...
          <Link 
            ...
            className={`flex items-center justify-between px-3 py-2.5 rounded-xl transition group border ${
              isActive('/platform/network') ? 'bg-primary/5 text-primary border-primary/20 shadow-sm' : 'border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex items-center justify-between px-3 py-2.5 rounded-xl transition group border ${
              isActive('/platform/events') ? 'bg-primary/5 text-primary border-primary/20 shadow-sm' : 'border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex items-center justify-between px-3 py-2.5 rounded-xl transition group border ${
              isActive('/platform/mentors') ? 'bg-primary/5 text-primary border-primary/20 shadow-sm' : 'border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50'
            }`}
          >
          ...
          <Link 
            ...
            className={`flex items-center justify-between px-3 py-2.5 rounded-xl transition group border ${
              isActive('/platform/marketplace') ? 'bg-primary/5 text-primary border-primary/20 shadow-sm' : 'border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50'
            }`}
          >
