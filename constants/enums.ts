...
export type UserPlatformRole = Database['public']['Enums']['user_platform_role'];
...
export const USER_PLATFORM_ROLE_OPTIONS: { value: UserPlatformRole; label: string }[] = [
  { value: 'base', label: 'Base Builder' },
  { value: 'enrolled', label: 'Program Enrolled' },
  { value: 'member', label: 'Network Member' },
  { value: 'provider', label: 'Perk Provider' },
